...
| `index.html`、`report/`、`dashboard/` | GitHub Pages 网站：三循环首页、三份循环交互报告、飞书经营看板与数据透视 | 在线演示源文件 |
| `output/html/圣农经营智能中枢_飞书经营看板.html` | 经营事件协作台演示（脱敏演示数据） | 离线交互演示 |
| `tests/`、`scripts/` | 网页与打包测试、交付包构建 | 验证交付完整性 |

2026-07-19 版方案 PDF（`圣农经营智能中枢_评委版母方案.pdf`、`圣农经营智能中枢_完整方案母稿.pdf`、`docs/评委版母方案/`、`output/pdf/`）为早期版本，叙事已被三循环版本取代，仅供追溯。早期九节点网页主站（`圣农经营智能中枢_Aily叙事副本.js`、`shengnong-nodes/`、`output/html/圣农经营智能中枢_Aily叙事副本.html`）已被三循环新首页取代，保留供追溯。
